...
b)  other server components are reachable only through this component
...
d)  maintain certificates and its validity (recurring renewal) issued by public trusted CAs
...
f)  provide migration possibilities
...
f)  handover results back *Permission Manager*
...
a unified facility to for server components to distribute notifications to multiple front ends 
...
a)  data structure and format MUST be known by the system
