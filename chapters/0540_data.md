...
The core task of a *ReFlowd* is providing data, *Personal Data*, which is the digital manifestation of 
...
introduced [scenarios](#scenarios) *(Chapter 1)*.  
...
c)  Third party software, for example a browser plugin, is used to provide the *ReFlowd* with data; in
this case, a browser history. This software uses a restricted API provided by the *ReFlowd* to let 
...
Data Modelling in general is a large research field to its own. With regards to the *ReFlowd* it needs 
