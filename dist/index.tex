...
\textbf{HTTP(S)} {[}\protect\hyperlink{ref-web_spec_http1}{74}{]}, well
...
\emph{(JWT)} {[}\protect\hyperlink{ref-web_spec_json-web-token}{85}{]}.
...
\textbf{\emph{\protect\hypertarget{sa02}{}{S.A.02}} - Roles}\\
...
\textbf{\emph{\protect\hypertarget{sa03}{}{S.A.03}} - Authenticity}\\
Since they have to rely on the data, both entities - everyone belonging
to one of the \emph{\protect\hyperlink{sa02}{roles}} - should be able to
ensure it's authenticity and the data in question to it's opponent. It
should be possible to opt out, if that level of reliability is not
necessary. Whereas if one of the parties demanding the other one of
providing such level, but the other doesn't, then the access attempt
will fail.
...
Authentication}\label{verification-authentication}
