...
data points are requested to access, how often they can be accessed and
how long those permissions last. The latter is defined as
\emph{permission type} and can be one of the following:
