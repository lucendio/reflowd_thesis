...
having been installed on the \emph{PDaaS} that is certified and
therefore trusted by a trustworthy public CA, as mentioned above. Then
...
public key by itself. Before \emph{consumers} are presented with the
...
what data points are permitted to access, how often they can be
