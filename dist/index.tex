...
At the end every subchapter includes a section containing a summary of
conclusions, which are based on prior discussions about the related
topic.
...
\item
  ...
  {[}\protect\hyperlink{ref-web_2009-success-of-facebook-connect}{105}{]}.
\end{itemize}
...
{[}105{]} N. Carlson, ``Facebook connect is a huge success -- by the
