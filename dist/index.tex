...
Promoted from the data subject to the data owner, in the center of the
\emph{PDaaS}, the operator gains abilities to have as much control over
all the data related to her as possible, to determine in a very precise
ways what data of hers can be accessed by third parties and to literally
carry all her personal data with her.
...
So the \emph{data consumer} must be certain that the received data is
correct and authentic, and those really belong to the individual, who is
currently involved in that specific process.
...
\tightlist
\item
  NOTE: does not mean this tool authenticates it's associates data
  subject against third party platforms like OpenID does. but it could
  play the role of the 2n factor in a multi-factor authentication
...
\section{Flexible Application}\label{flexible-application}

\begin{itemize}
\tightlist
\item
  using and fitting into all kinds of scenarios: e.g.~storing cara data,
  providing sensitive profile data, being patient file
\item
...
upon open technologies, which is understood as open standards and open
source; \emph{open} in the sense of \emph{unrestricted accessible by
everybody}; not to be confused with free - as in \emph{freedom} -
...
ensure the authenticity of it's opponent and the data in question. It
...
\section{Data Exchange/Access Process
...
\item
  ...
  {[}\protect\hyperlink{ref-web_2009-success-of-facebook-connect}{104}{]}.
\end{itemize}
...
{[}104{]} N. Carlson, ``Facebook connect is a huge success -- by the
