...
post appropriate technology for communicating with the \emph{PDaaS} over
the internet is \emph{\protect\hyperlink{link_http}{HTTP}}. This
comprehensive and flexible protocol enables a variety of applications.
...
{[}\protect\hyperlink{ref-web_2013_npa-sicherheitsdefizit}{105}{]} and
disadvantages
{[}\protect\hyperlink{ref-web_2014_test-qes-support-in-npa}{106}{]} an
...
{[}\protect\hyperlink{ref-web_bsi-eid}{107}{]} starting with making an
application in order to get permission for sending a certificate signing
request to a BerCA.\footnote{Berechtigungszertifikate-Anbieter} This
request is originated from an \emph{eID-Server}
{[}\protect\hyperlink{ref-web_2017_npa-eid-server}{108}{]} to sign a
...
required for creating a \emph{QES}\footnote{Qualified Electronic
  Signatures
  {[}\protect\hyperlink{ref-paper_2013-keymanangement-fuer-qes-mit-npa}{109}{]}}
...
\item
  ...
  {[}\protect\hyperlink{ref-web_2009-success-of-facebook-connect}{112}{]}.
\end{itemize}
...
{[}105{]} ``Basisleser weiterhin kritische schwachstelle des
...
{[}106{]} O. Stiemerling, ``Qualifizierte elektronische signatur mit dem
...
\hypertarget{ref-web_bsi-eid}{}
{[}107{]} ``BSI - technische richtlinien des BSI - BSI TR-03130
...
{[}108{]} ``Personalausweisportal - eID-server.'' {[}Online{]}.
Available:
...
{[}109{]} K. Nguyen and C. Schwarz, ``Innovatives key management für die
...
{[}110{]} D. B. der Bundesregierung für Informationstechnik,
...
{[}111{]} L. Neumann, ``Stellungnahme zum elektronischen
...
{[}112{]} N. Carlson, ``Facebook connect is a huge success -- by the
