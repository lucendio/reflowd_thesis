...
support the underlying technologies, such as HTTP and TLS. Thus the
emerging system should implement a web service, who provide controlled
...
\item
  ...
  \end{itemize}
\item
  since there are no time constrains when it comes to communication with
  a payload that relates to personal data, the encryption procedures can
  be as costly as the system resources allow them to be, thus the level
  of security can be increased.
\end{itemize}
