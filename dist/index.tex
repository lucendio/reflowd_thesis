...
interpreted as defined there. This applies to the following keywords,
recognizable through capital letters: MUST, MUST NOTE, SHOULD
...
\subsection{Depending Technologies}\label{depending-technologies}
...
\item
  domain
\item
  publicly reachable server (e.g public IP)
\item
