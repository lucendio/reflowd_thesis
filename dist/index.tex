...
{[}\protect\hyperlink{ref-web_2016_wikipedia_separation-of-concerns}{123}{]}.
...
\emph{web server's} capabilities. Although, it makes more sense to
...
requests from getting further into the system.
...
\item
  ...
  {[}\protect\hyperlink{ref-web_2009-success-of-facebook-connect}{124}{]}.
\end{itemize}
...
{[}123{]} ``Separation of concerns,'' 01-Nov-2016. {[}Online{]}.
Available:
...
{[}124{]} N. Carlson, ``Facebook connect is a huge success -- by the
