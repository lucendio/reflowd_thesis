...
\item[Big Data:]
A collective term and philosophy that involves collecting, aggregating
and analyzing data about each and everything (e.g.~personal data, sensor
data, transactional data, meta data). As the amount of data has started
to exceed the capabilities of standalone computers and storages,
distributed storing and parallel computing have been utilized in these
fields. In order to be able to find meaningful data so that in can back
decision-making processes, technologies from the fields of
\emph{artificial intelligence} and \emph{machine learning} (e.g.~neural
networks) have been adapted.
\item[Profile Data:]
...
\item[Personal Data:]
Any data points or datasets that are created by or at least related to
an individual, including her \emph{digital footprint}.
...
sometimes referred to as \emph{(data) collector}.
\item[Data Broker:]
...
\item
  ...
  {[}\protect\hyperlink{ref-web_2016_wikipedia_intellectual-property}{16}{]}
...
Moore's Law {[}\protect\hyperlink{ref-paper_1965_moors-law}{57}{]}), at
...
{[}\protect\hyperlink{ref-web_spec_http1}{73}{]}, well known as the
...
\emph{WebSockes} {[}\protect\hyperlink{ref-web_spec_websockets}{75}{]}
...
\textbf{JSON}\footnote{The JavaScript Object Notation (JSON) Data
  ...
  {[}\protect\hyperlink{ref-web_spec_json}{76}{]} and Internet
  Engineering Task Force RFC 7159
  {[}\protect\hyperlink{ref-web_rfc_json}{77}{]}} is an alternative data
...
tends
{[}\protect\hyperlink{ref-web_2012_problem-with-oauth-for-authentication}{78}{]}
...
{[}\protect\hyperlink{ref-web_spec_oauth-1a}{79}{]}, commonly seen as a
...
2.0} {[}\protect\hyperlink{ref-web_spec_oauth-2}{80}{]}, labeled as a
...
living room devices''}
{[}\protect\hyperlink{ref-web_2016_oauth-2}{81}{]}.
...
{[}\protect\hyperlink{ref-web_spec_openid-connect-1}{82}{]} is the third
...
{[}\protect\hyperlink{ref-web_spec_json-web-token}{83}{]}. A \emph{JWT},
...
{[}\protect\hyperlink{ref-paper_1976_d-h-key-exchange}{86}{]} and is
...
{[}\protect\hyperlink{ref-book_2014_chapter-9-1-public-key-crypto}{87}{]},
...
{[}\protect\hyperlink{ref-web_spec_tls}{88}{]} (\emph{TLS}) results in
...
\textbf{REST(ful)}\footnote{\emph{Representational State Transfer},
  ...
  {[}\protect\hyperlink{ref-web_spec_rest}{91}{]}} is a common set of
...
vocabulary\footnote{knows as HTTP Methods or Verbs
  {[}\protect\hyperlink{ref-web_spec_http-methods}{92}{]} (e.g.~GET,
...
{[}\protect\hyperlink{ref-web_spec_graphql}{93}{]} stands for
...
essential for the \emph{Semantic Web}. RDF\footnote{Resource Description
  Framework {[}\protect\hyperlink{ref-web_w3c-tr_rdf}{94}{]}} basically
defines the syntax. OWL\footnote{Web Ontology Language
  {[}\protect\hyperlink{ref-web_w3c-tr_owl}{95}{]}} provides the
guidelines on how the semantics and schemas should be defined and with
\protect\hypertarget{link-sparql}{}{SPARQL}
{[}\protect\hyperlink{ref-web_w3c-tr_sparql}{96}{]}, the query language,
...
{[}\protect\hyperlink{ref-web_w3c-draft_webid}{97}{]}} - provided in a
...
called \textbf{Solid}.\footnote{social linked data
  {[}\protect\hyperlink{ref-web_spec_solid}{98}{]}} Based on the
\emph{Linked Data} principles and backed the \emph{WebAccessControl}
{[}\protect\hyperlink{ref-web_2016_wiki_webaccesscontrol}{99}{]} system
...
\emph{databox} {[}\protect\hyperlink{ref-web_2016_demo_databox}{100}{]}
...
Linux kernel. \emph{Cgroups},\footnote{control groups
  {[}\protect\hyperlink{ref-web_2015_cgroup-doc}{101}{]}} which define
...
{[}\protect\hyperlink{ref-web_2016_kernel-namespace}{102}{]} define or
...
{[}\protect\hyperlink{ref-web_2016_open-container-initiative}{103}{]},
...
{[}\protect\hyperlink{ref-web_oci-spec_runtime}{104}{]} and image
{[}\protect\hyperlink{ref-web_oci-spec_image}{105}{]} definition, on
...
minor flaws
{[}\protect\hyperlink{ref-web_2013_npa-sicherheitsdefizit}{106}{]} and
disadvantages
{[}\protect\hyperlink{ref-web_2014_test-qes-support-in-npa}{107}{]} an
...
{[}\protect\hyperlink{ref-web_2017_about-de-mail}{108}{]}. It's an
...
{[}\protect\hyperlink{ref-statement_2013_de-mail}{109}{]}, maybe even
...
{[}\protect\hyperlink{ref-book_2015_ethical-it-innovation}{110}{]}, then
...
{[}\protect\hyperlink{ref-paper_2004_distributed-mapreduce}{111}{]}. The
...
{[}\protect\hyperlink{ref-web_spec_tls-12_client-auth}{112}{]} it is
...
authentication}
{[}\protect\hyperlink{ref-web_2017_wikipedia_mutual-auth}{113}{]}) is
...
Resumption}
{[}\protect\hyperlink{ref-book_2013_networking-101_tls-session-resumption}{114}{]},
...
Resumption}
{[}\protect\hyperlink{ref-web_spec_tls-session-ticket-resumption}{115}{]}
...
\item
  ...
  requirements {[}\protect\hyperlink{ref-web_bsi-spec_eid}{116}{]}
  ...
  \emph{eID-Server}
  {[}\protect\hyperlink{ref-web_2017_npa-eid-server}{117}{]} in order to
...
{[}\protect\hyperlink{ref-book_2014_chapter-10-5-asym-random-number-gen}{118}{]},
...
{[}\protect\hyperlink{ref-web_spec_http-error-codes}{119}{]} might be a
...
documentations
{[}\protect\hyperlink{ref-web_spec_oauth-1a_client-reg}{120}{]}
{[}\protect\hyperlink{ref-web_spec_oauth-2_client-reg}{121}{]}, both
...
\item
  ...
  {[}\protect\hyperlink{ref-web_spec_oauth-1a_access-verification}{122}{]}
  {[}\protect\hyperlink{ref-web_spec_oauth-2_access-verification}{123}{]}.
...
\emph{medical record}
{[}\protect\hyperlink{ref-web_spec_data-schemas_ehr}{124}{]},
\emph{point of interest}
{[}\protect\hyperlink{ref-web_spec_data-schemas_poi}{125}{]} or
\emph{bank transfer}
{[}\protect\hyperlink{ref-web_spec_data-schemas_bank-transfer}{126}{]}.
...
{[}\protect\hyperlink{ref-web_spec_xml_types}{127}{]} and \emph{GraphQL}
{[}\protect\hyperlink{ref-web_spec_graphql_types}{128}{]}. When choosing
...
{[}\protect\hyperlink{ref-web_2016_wikipedia_separation-of-concerns}{129}{]}.
...
\item
  X.509
\item
  ACME {[}\protect\hyperlink{ref-web_spec_acme}{130}{]} (Let's Encrypt)
\end{itemize}
...
parties
{[}\protect\hyperlink{ref-web_2009-success-of-facebook-connect}{131}{]}
...
specification}} {[}\protect\hyperlink{ref-web_oci-spec_image}{105}{]}.
...
{[}\protect\hyperlink{ref-web_2016_wikipedia_accordion-gui}{132}{]} for
...
{[}\protect\hyperlink{ref-web_2017_repo_node-simple-schema}{133}{]}.}
...
{[}16{]} \emph{Outline of intellectual property}. URL
...
{[}17{]} Regulation (EU) 2016/679 --- General data protection
regulation, 2016 --~scale

\hypertarget{ref-web_2016_wikipedia_information-privacy-law_us}{}
{[}18{]} \textsc{Wikipedia}: \emph{Information privacy law}. URL
...
{[}19{]} \textsc{Loeb), Ieuan Jolly (Loeb \&}: \emph{PLC - data
...
{[}20{]} \textsc{Wilhelm, Alex}: \emph{White house drops ``consumer
...
{[}21{]} Consumer privacy bill of rights act (cpbora) --- Administration
...
{[}22{]} FCC 16-148 --- Report and order, 2016 --~scale. ---~In the
...
{[}23{]} FCC 16-39 --- Notice of proposed rulemaking, 2016 --~scale.
...
{[}24{]} \emph{Privacy policies are mandatory by law}. URL
...
{[}26{]} \textsc{Rosner, Gilad}: Who owns your data? In: ~: ACM Press,
2014 ---~ISBN~978-1-4503-3047-3, pp.~623--628

\hypertarget{ref-book_1987_private-ownership_definition}{}
{[}27{]} \textsc{Grunebaum, J.O.}: \emph{Private ownership},
...
{[}28{]} Regulation (EU) 2016/679 --- General data protection
regulation, 2016 --~scale

\hypertarget{ref-rules_2016_fcc_to-protect-broadband-consumer-privacy_ownership}{}
{[}29{]} FCC 16-148 --- Report and order, 2016 --~scale. ---~In the
Matter of Protecting the Privacy of Customers of Broadband and Other
Telecommunications Services

\hypertarget{ref-web_2016_facebook_terms-of-service}{}
{[}30{]} \textsc{Facebook}: \emph{Facebooks's terms of service.
...
{[}31{]} \textsc{Twitter}: \emph{Twitters's terms of service. Twitter
...
{[}32{]} \textsc{Google}: \emph{Google's terms of service. Google terms
of service}. URL
\url{https://www.google.com/intl/en/policies/terms/regional.html}. -
retrieved 2016-12-01

\hypertarget{ref-web_2016_apple-icloud_terms-of-service}{}
{[}33{]} \textsc{Apple}: \emph{Apple's iClound terms and conditions. V.
...
{[}34{]} \emph{Why metadata matters}. URL
...
{[}35{]} \textsc{Stevens, John P.}: \emph{Why you need metadata for big
data success}. URL
...
{[}38{]} \textsc{Tsai, Chun-Wei}\,; \textsc{Lai, Chin-Feng}\,;
...
{[}39{]} \textsc{Zaïane, Osmar R}: \emph{Principles of knowledge
discovery in databases}, 1999 --~scale

\hypertarget{ref-web_2013_big-data-collection-collides-with-privacy-concerns}{}
{[}40{]} \emph{Big data collection collides with privacy concerns,
...
{[}43{]} \textsc{Laney, Douglas}: \emph{3D data management: Controlling
...
{[}44{]} \textsc{Hilbert, Martin}: Big data for development: A review of
...
{[}45{]} \textsc{Davis Kho, Nancy}: \emph{The state of big data}. URL
...
{[}46{]} \textsc{CEO), Tim Cook (Apple's}: \emph{A message to our
...
{[}47{]} \textsc{Green, Matthew}: \emph{What is differential privacy? A
...
{[}48{]} \textsc{Budington, Bill}: \emph{WhatsApp rolls out end-to-end
...
{[}49{]} \emph{Stuck in traffic? Insights from googlers into our
...
{[}50{]} \textsc{Wikipedia}: \emph{Google traffic}. URL
...
{[}51{]} \emph{Global mobile OS market share}. URL
...
{[}52{]} \textsc{Ao, Ji}\,; \textsc{Zhang, Peng}\,; \textsc{Cao, Yanan}:
...
{[}53{]} \textsc{Palem, Gopalakrishna}: The Practice of Predictive
Analytics in Healthcare. In: \emph{ResearchGate} (2013)

\hypertarget{ref-data-collection-for-climate-changes_2014}{}
{[}54{]} \textsc{Burger, Nicholas}\,; \textsc{Ghosh-Dastidar, Bonnie}\,;
...
{[}55{]} \textsc{Gaitho, Maryanne}: \emph{Applications of big data in 10
...
{[}56{]} \textsc{USA, Federal Trade Commission}: \emph{Personal data
ecosystem}. URL
...
{[}60{]} \emph{ProjectVRM - cDevelopment work. ProjectVRM}. URL
...
{[}61{]} \emph{ProjectVRM - principles. ProjectVRM}. URL
...
{[}65{]} \textsc{Montjoye, Yves-Alexandre de}\,; \textsc{Wang, Samuel
...
{[}66{]} \emph{openPDS/SafeAnswers - the privacy-preserving personal
...
{[}67{]} \textsc{Montjoye, Yves-Alexandre de}\,; \textsc{Shmueli,
...
{[}73{]} \textsc{Leach, Paul J.}\,; \textsc{Berners-Lee, Tim}\,;
...
{[}74{]} \textsc{Belshe, Mike}\,; \textsc{Thomson, Martin}\,;
...
{[}75{]} \textsc{Fette, Ian}\,; \textsc{Melnikov, A.}: \emph{The
WebSocket protocol}. URL \url{https://tools.ietf.org/html/rfc6455}. -
retrieved 2016-12-17

\hypertarget{ref-web_spec_json}{}
{[}76{]} \textsc{Crockford, Douglas}: The JSON data interchange format.

\hypertarget{ref-web_rfc_json}{}
{[}77{]} \textsc{Bray, T.}: \emph{The JavaScript object notation (JSON)
...
{[}84{]} \textsc{Hildebrand, Joe}\,; \textsc{Jones, Michael}: \emph{JSON
...
{[}86{]} \textsc{Diffie, Whitfield}\,; \textsc{Hellman, Martin}: New
...
{[}87{]} \textsc{Stallings, William}: 9.1 principles of public-key
...
{[}91{]} \textsc{Fielding, Thomas}: Representational state transfer
...
{[}92{]} \textsc{Leach, Paul J.}\,; \textsc{Berners-Lee, Tim}\,;
\textsc{Mogul, Jeffrey C.}\,; \textsc{Masinter, Larry}\,;
...
{[}93{]} \emph{GraphQL}. URL \url{https://facebook.github.io/graphql/}.
- retrieved 2016-12-17

\hypertarget{ref-web_w3c-tr_rdf}{}
{[}94{]} \textsc{Beckett, Dave}\,; \textsc{McBride, Brian}:
...
{[}95{]} \textsc{W3C OWL Working Group}: \emph{OWL 2 web ontology
...
{[}96{]} \textsc{Harris, Steve}\,; \textsc{Seaborne, Andy}\,;
...
{[}107{]} \textsc{Stiemerling, Oliver}: \emph{Qualifizierte
...
{[}108{]} \textsc{Bundesregierung für Informationstechnik, Der
...
{[}109{]} \textsc{Neumann, Linus}: Stellungnahme zum elektronischen
rechtsverkehr.

\hypertarget{ref-book_2015_ethical-it-innovation}{}
{[}110{]} \textsc{Spiekermann, Sarah}: \emph{Ethical IT Innovation: A
Value-Based System Design Approach}~: CRC Press; Taylor \& Francis
Group, LLC, 2015 --~scale ---~ISBN~978-1-4822-2635-5

\hypertarget{ref-paper_2004_distributed-mapreduce}{}
{[}111{]} \textsc{Dean, Eeffrey}\,; \textsc{Ghemawat, Sanjay}:
MapRednce: Simplified data processing on large clusters (2004)

\hypertarget{ref-web_spec_tls-12_client-auth}{}
{[}112{]} \textsc{Dierks, Tim}: \emph{The transport layer security (TLS)
...
{[}113{]} \emph{Mutual authentication}. URL
...
{[}114{]} \emph{Networking 101: Transport layer security (TLS) - high
...
{[}115{]} \textsc{Joseph Salowey, P. Eronen, \textnormal{H. Zhou}}:
...
{[}116{]} \emph{BSI - technische richtlinien des BSI - BSI TR-03130
eID-server}. URL
...
{[}117{]} \emph{Personalausweisportal - eID-server}. URL
...
{[}118{]} \textsc{Stallings, William}: 9.1 public-key infrastructure.
...
{[}119{]} \textsc{Leach, Paul J.}\,; \textsc{Berners-Lee, Tim}\,;
\textsc{Mogul, Jeffrey C.}\,; \textsc{Masinter, Larry}\,;
\textsc{Fielding, Roy T.}\,; \textsc{Gettys, James}: \emph{Hypertext
transfer protocol -- HTTP/1.1}. URL
...
{[}124{]} \textsc{Foundation}: \emph{OpenEHR - EHR information model}.
...
{[}127{]} \textsc{W3C}: \emph{XML schema part 2: Datatypes second
edition}. URL
...
{[}130{]} \textsc{Kasten, James}\,; \textsc{Barnes, Richard}\,;
...
{[}131{]} \textsc{Carlson, Nicholas}: \emph{Facebook connect is a huge
...
{[}133{]} \emph{Aldeed/node-simple-schema. GitHub}. URL
